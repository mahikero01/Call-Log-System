...
<?php Helper::layout_template('head_common.php'); ?>
	...
	<body>
			<div id="header">
				<h1>Audit User Calls</h1>
			</div>
			
			<div id="content">
				<div id="content_header" >
					Select  user call data you want to audit.<br />
				</div>
				<div id="tasklist">	
					<!-- <form action="lib/test.php" method="POST"> -->
					  <form action="lib/check_all_user_calls_process.php" method="POST"> 
						<br />
 						<label for="user">User Local</label>
						<input type="text" name="user" id="user" size="1" maxlength="3" value=""></input>
