...
$page_all_call_record = new Pagination($current_page, 20, 
	$all_call_record->number_of_record_user($current_date_from, $current_date_to, $current_local, $current_call_type));
...
if ( $current_page > $page_all_call_record->total_pages()) {
	...
	$all_call_record->get_all_data_user($current_call_type, $current_date_from, $current_date_to,
		$current_local, $page_all_call_record->offset());
	...
	for ($count=0; $count<=19; $count++) {
		...
		if (isset($_POST[$post_str_ok])) {
			...
			$post_message = $all_call_record->update_call_record($all_call_record->all_made_calls[$count]['call_log_id'], 
				$_POST[$post_str_prc], $current_bill, $pay_status);	
				$str = 	'check_all_user_calls.php?page='.$current_page;
			...
			<div id="content">
				<div id="content_header">
					<?php 
						...
						echo $message_report; 
						$message_report = 'Found '.$all_call_record->number_of_record_user($current_date_from,
							$current_date_to, $current_local, $current_call_type).' Total Records';
				...
				<br />
				<?php $page_str = "check_all_user_calls.php?page=".$_GET['page']; 
			...
			<div id="task">
				...
				<div id="tasklist">		
					<ul>
						...
						<li><a class="taskselection" href="audit_user_calls.php">Return to Audit User Calls</a></li>
						<br />
				...
				<div class="task_select_head">				
					...
					if ($page_all_call_record->has_previous_page()) {
						$url_page = 'check_all_user_calls.php';
